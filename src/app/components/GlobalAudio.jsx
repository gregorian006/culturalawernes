...
const GlobalAudio = () => {
  ...
  return (
    // PERBAIKAN:
    // 1. bottom-4 right-4: Jarak pinggir lebih rapat di HP.
    // 2. scale-75 md:scale-100: Di HP ukurannya 75%, di Desktop 100%.
    // 3. origin-bottom-right: Mengecil ke arah pojok, bukan ke tengah.
